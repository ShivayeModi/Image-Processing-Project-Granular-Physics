...
#os.mkdir("piv_set_diff_10_uniscale")
for j in range(1643,3958): # j as frame index
 ...
 for i in range(1,175): # i as ring index
    ...
    arrow_length = int((40 /max_vel) * vel_x[j])
 ...
 cv2.waitKey(1)
 cv2.imwrite("F:\\summer project\\image processing\\cross correlation\\piv_set_diff_10_uniscale"+"\\"+"frame_"+str(j)+"diff_10"+".jpg",img)
